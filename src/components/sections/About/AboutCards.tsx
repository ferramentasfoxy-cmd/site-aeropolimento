    ...
    <div ref={containerRef} className="flex flex-col gap-4 w-full">
      {CARDS.map((card, i) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-aero-red/[0.03] to-transparent -translate-x-[150%] group-hover:translate-x-[150%] transition-transform duration-[1200ms] ease-in-out pointer-events-none" />
          
          <div className="flex gap-5 relative z-10">
            {/* Linha indicadora lateral técnica */}
            <div className="w-[3px] h-6 bg-aero-red rounded-full shrink-0 mt-1 transition-all duration-500 group-hover:h-8 group-hover:shadow-[0_0_12px_rgba(189,22,34,0.4)]" />
