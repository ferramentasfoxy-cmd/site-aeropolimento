    ...
    <section ref={heroRef} className="hero-section relative w-full h-[100vh] min-h-[800px] overflow-hidden bg-[var(--color-bg-primary)]">
      ...
      <div className="absolute top-0 right-0 w-full lg:w-[55%] h-[100vh] z-0 translate-x-[4%] lg:translate-x-[6%] hero-3d-layer">
        ...
        <div className="absolute bottom-[20%] left-[20%] xl:left-[28%] z-20 hud-aesthetic opacity-0 hidden lg:block group cursor-default">
          <div className="bg-white rounded-[20px] shadow-[0_20px_60px_rgba(0,0,0,0.12)] group-hover:shadow-[0_25px_60px_rgba(189,22,34,0.12)] p-3 pr-8 flex items-center gap-4 border border-gray-300 xl:border-gray-200 relative overflow-hidden transition-all duration-500 group-hover:-translate-y-1.5">
            ...
            <div className="w-12 h-12 bg-[var(--color-text-primary)] rounded-full flex items-center justify-center text-white shrink-0 shadow-md group-hover:bg-aero-red group-hover:scale-105 transition-all duration-500 relative z-20">
